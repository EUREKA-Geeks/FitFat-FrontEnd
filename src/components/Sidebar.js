...
import Gym from "/home/malek/project-401/FitFat-FrontEnd/src/pages/Gym.js"
import Trainers from "/home/malek/project-401/FitFat-FrontEnd/src/pages/Trainers.js"
import Session from "/home/malek/project-401/FitFat-FrontEnd/src/pages/Session.js"
import UserProfile from "/home/malek/project-401/FitFat-FrontEnd/src/pages/UserProfile.js"
        ...
        return (
            ...
            <div className='parent'>
                <section className='left'>
                    ...
                    <Nav.Link as={Link} to={UserProfile} onClick={this.showProfile}>  <span className="me-5">My profile</span> 
                     </Nav.Link>

                    </div>

                    <div className='container'>
                     <Nav.Link as={Link} to={Gym} onClick={this.showGym}>  <span className="me-5">Gym</span> 
                     </Nav.Link>
                    
                     <Nav.Link as={Link} to={Trainers}onClick={this.showTrainers}> <span className="me-5">Trainers</span> 
                     </Nav.Link>

                     <Nav.Link as={Link} to={Session}onClick={this.showSession}> <span className="me-5">Session</span> 
                     </Nav.Link>
                    </div>
